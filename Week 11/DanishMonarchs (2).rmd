...
kings1 <- read.csv("Projekter i dam /Aflevering dam/data/kongerække færdig-kopi slut .csv")

kings2 <- read_csv("Projekter i dam /Aflevering dam/data/kongerække færdig-kopi slut .csv")

kings3 <- read.csv2("Projekter i dam /Aflevering dam/data/kongerække færdig-kopi slut .csv")

kings4 <- read_csv2( "Projekter i dam /Aflevering dam/data/kongerække færdig-kopi slut .csv")
```
...
kings4 <- read_csv2("Projekter i dam /Aflevering dam/data/kongerække færdig-kopi slut .csv", na =c("NULL","")) # this is the right funjction for my dataset
